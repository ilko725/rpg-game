...
// const fieldRender = () => {
//     ctx.lineWidth = 10;
//     ctx.fillStyle = 'rgba(200, 210, 140, 0.5)';
//     for (let i = 0; i < canvasW; i += 50) {
//         ctx.fillRect(19 + i, 24, 10, 560);
//     }
//     for (let i = 0; i < canvasH; i += 50) {
//         ctx.fillRect(19, 24 + i, 560, 10);
//     }
...
//     ctx.beginPath();
//     ctx.moveTo(225, 225);
//     ctx.arc(225, 225, 24, 0.2 * Math.PI, 1.8 * Math.PI);
//     ctx.moveTo(225, 225);
//     ctx.fill();
//     ctx.stroke();
// };
